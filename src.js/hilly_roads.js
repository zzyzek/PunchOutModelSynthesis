...
function init_template(template) {
  ...
  let template_widget = {
    ...
    "G" : { "x+": "*:E,*:.","x-": "*:E,*:.","y+": "*:E,*:.","y-": "*:E,*:.","z+": "*:E",    "z-": "*:."  },
    //"l" : { "x+": "*:E",    "x-": "*:.",    "y+": "*:E",    "y-": "*:.",    "z+": "*:E",    "z-": "*:."  },
    //"L" : { "x+": "*:E",    "x-": "*:E",    "y+": "*:E",    "y-": "*:.",    "z+": "*:E",    "z-": "*:."  },

    "E" : { "x+": "*:E",     "x-": "*:E",     "y+": "*:E",    "y-": "*:E",    "z+": "*:E",    "z-": "*:E"  },
    "e" : { "x+": "=:e",     "x-": "=:e",     "y+": "=:e",    "y-": "=:e",    "z+": "*:.",    "z-": "*:E"  },

    "H" : { "x+": "$:Hs",    "x-": "$:Hs",    "y+": "*:E",    "y-": "=:e,*:.","z+": "$:Hu",   "z-": "*:E"  },
    "h" : { "x+": "$:hs",    "x-": "$:hs",    "y+": "=:e",    "y-": "*:.",    "z+": "*:.",    "z-": "$:Hu" },

    "B" : { "x+": "=:e,*:.", "x-": "$:Hs",    "y+": "$:Hs",   "y-": "=:e,*:.","z+": "$:Bu",   "z-": "*:E"  },
    "b" : { "x+": "*:.",     "x-": "$:hs",    "y+": "$:hs",   "y-": "*:.",    "z+": "*:.",    "z-": "$:Bu" },

    "p" : { "x+": "=:e",     "x-": "=:e",     "y+": "=:pxy",  "y-": "=:pxy",  "z+": "*:.",    "z-": "*:E"  },
    "r" : { "x+": "=:pxy",   "x-": "=:e",     "y+": "=:e",    "y-": "=:pxy",  "z+": "*:.",    "z-": "*:E"  },
    "c" : { "x+": "=:pxy",   "x-": "=:pxy",   "y+": "=:pxy",  "y-": "=:pxy",  "z+": "*:.",    "z-": "*:E"  },
    "v" : { "x+": "$:Hs",    "x-": "$:Hs",    "y+": "*:E",    "y-": "=:pxy",  "z+": "$:pu",   "z-": "*:E"  },
  ...
  template["endpoint_order"] = [ "_", "G",  "E", "e", "H", "h", "B", "b", "p", "r", "c", "v", "^", ];
  ...
  */
  ...
  _r = _3rect_xz( 1/2, 1, -1/4, -1/2, 0, 0);
  for (let j=0; j<_r.length; j++) { fB.push(_r[j]); }

  _r = _3rect_zy( 1, 1/2,  -1/2, -1/4, 0, 0);
  for (let j=0; j<_r.length; j++) { fB.push(_r[j]); }

  // front tri and side slope
  //
  tri = [];
  tri.push( [    0, -1/2,  1/2 ] );
  tri.push( [    0, -1/2, -1/2 ] );
...
var OUT_FN = "hilly_roads_poms.json";
var OUT_DIR = "hilly_roads";
var OBJ_DIR = "hilly_roads_obj";
...
poms_json.constraint.push({ "type":"remove", "range":{"tile":[1,2], "x":[], "y":[], "z":[1]} });
poms_json.constraint.push({ "type":"remove", "range":{"tile":[2], "x":[], "y":[], "z":[0,1]} });
poms_json.constraint.push({ "type":"remove", "range":{"tile":[0,1], "x":[], "y":[], "z":[0,1]} });
